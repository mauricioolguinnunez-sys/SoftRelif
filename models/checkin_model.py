...
class CheckinModel:
    """
    Modelo de check-ins emocionales en MongoDB (colección de bienestar).

    Cada documento se identifica por id_usuario y contiene la lista
    histórica de check-ins con sus respuestas y métricas.
    """
    ...
    def ensure_user_document(id_usuario):
        collection = CheckinModel._collection()
    ...
    def save_checkin(id_usuario, tipo_checkin, titulo_checkin, estado_animo_general, respuestas, recomendacion_automatica=None):
        ...
        CheckinModel.ensure_user_document(id_usuario)
    ...
    def get_user_checkins(id_usuario, limit=30):
        doc = CheckinModel.ensure_user_document(id_usuario)
    ...
    def get_specialist_user_history(id_usuario):
        ...
        checkins = CheckinModel.get_user_checkins(id_usuario, limit=20)
        return {
            "resumen": summary,
            "checkins": checkins
        }
