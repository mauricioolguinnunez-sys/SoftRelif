...
& $py -m PyInstaller --noconfirm --clean --onefile --windowed --name SoftRelief --add-data "assets;assets" --add-data "games;games" --add-data ".env;." --hidden-import cryptography main.py
